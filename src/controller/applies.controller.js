...
exports.takeActionForJob = async (req, res) => {
    try {
        ...
        if (findAppliesData) {
            ...
            let filePath = '/home/parth/Project/Project/backend/views/jobInterviewMail.ejs'
...
exports.takeActionForIntern = async (req, res) => {
    try {
        ...
        if (findAppliesData) {
            ...
            let filePath = '/home/parth/Project/Project/backend/views/internInterviewMail.ejs'
    ...
    try {
        ...
        if (findAppliesData) {
            ...
            if (req.body.status == 3) {
                 ...
                 let content = { "userName": findAppliesData.username, "companyName" : findAppliesData.company_name };
                 let filePath = '/home/parth/Project/Project/backend/views/hiredMail.ejs'
                ...
                let content = { "userName": findAppliesData.username, "companyName" : findAppliesData.company_name };
                let filePath = '/home/parth/Project/Project/backend/views/rejectionMail.ejs'
